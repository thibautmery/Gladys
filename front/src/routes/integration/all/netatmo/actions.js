  ...
  const actions = {
    ...
    async saveConfiguration(state) {
      ...
      if (state.netatmoConnectStatus !== RequestStatus.ServiceConnected) {
        console.log("netatmo non connecté")
        ...
        console.log("netatmo déjà connecté")
      }
      try {
...
console.log("getNetatmoDeviceSensors-coucou 21")
            netatmoSensorsDiscover[keyNetatmoSensorsDiscover].not_handled = true;
          } else {
console.log("getNetatmoDeviceSensors-coucou 22")
        ...
        netatmoSensorsDiscover.forEach(sensor => {
          ...
          if (indexNetatmoSensorsFiltered === -1) {
console.log("getNetatmoDeviceSensors-coucou 3")
            netatmoSensors[netatmoSensors.length] = netatmoSensorsDiscover[keyNetatmoSensorsDiscover];
          }
          keyNetatmoSensorsDiscover = keyNetatmoSensorsDiscover + 1;
        });

console.log("getNetatmoDeviceSensors-coucou 4")
console.log(netatmoSensors)
        if (netatmoSensors[0]) {
console.log("getNetatmoDeviceSensors-coucou 51")
          store.setState({
            netatmoSensors,
            getNetatmoDeviceSensorsStatus: RequestStatus.Success,
          });
        } else {
console.log("getNetatmoDeviceSensors-coucou 52")
          store.setState({
            getNetatmoDeviceSensorsStatus: RequestStatus.ConnectedNoDevice,
          });
        }
      } catch (e) {
console.log("getNetatmoDeviceSensors-coucou 6")
        store.setState({
